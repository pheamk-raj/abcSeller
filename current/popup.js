...
function getCurrentTabUrl(callback) {
  ...
  chrome.tabs.query(queryInfo, function(tabs){
	...
	switch(j){
		case 1:
			createHTML(tab,"s-result-list=s-access-detail-page,a-carousel-viewport=s-access-detail-page,widgetContent=dealTitleTwoLine,zg_more_allItems=a-link-normal","am","");
		break;
		case 2:
